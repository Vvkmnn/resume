...
\name{Vivek}{Menon}
\position{Data Scientist{\enskip\cdotp\enskip}AI
  Researcher{\enskip\cdotp\enskip}Technical Lead}
...
\makecvfooter
{\thepage} % {\today}
{\href{https://vvkmnn.xyz/}{Vivek Menon}~~~·~~~Curriculum Vitae}
{\today}% {\thepage}
